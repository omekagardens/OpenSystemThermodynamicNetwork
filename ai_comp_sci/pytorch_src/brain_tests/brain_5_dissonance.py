...
# --- DET 9.0 CONFIGURATION (COGNITIVE DISSONANCE TEST) ---
CUBE_SIZE = 12          
DIFFUSION_RATE = 0.15   
DECAY_RATE = 0.005      
LEARNING_RATE = 2.0     
STEPS = 1500            
REPORT_INTERVAL = 10
DATA_OUTPUT_FILE = "det_dissonance_data.json" # New filename
...
class BioCube:
    ...
    def step(self, step_count):
        ...
        # --- 2. SHARED PLASTICITY ---
        # Atrophy kicks in to prune unused connections
        ...
        # --- 3. INPUTS & TARGETS (DISSONANCE MODE) ---
        # Vision follows SINE wave
        # Sound follows COSINE wave
        # This creates a constant "phase drag" or dissonance between the signals
        ...
        # Concept Score: The intersection of the two.
        # In dissonance, we expect this to be unstable.
    ...
    def save_data(self):
        print(f"\nSaving dissonance analysis data to {DATA_OUTPUT_FILE}...")
...
ax.set_title("DET 9.0: Cognitive Dissonance Test (Phase Mismatch)")
...
print("Simulating DET 9.0 Dissonance Test...")
print("-" * 60)
